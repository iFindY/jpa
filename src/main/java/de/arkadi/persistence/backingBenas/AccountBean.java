...
import de.arkadi.persistence.model.User;
import de.arkadi.persistence.model.UserRole;
import de.arkadi.persistence.util.PasswordUtils;
...
public class AccountBean implements Serializable {
    //ide not smart  to detect bean it will run
    // ======================================
    // =          Injection Points          =
    // ======================================
