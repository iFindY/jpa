package de.arkadi.persistence.rest.domain;

import de.arkadi.persistence.model.Author;
import de.arkadi.persistence.rest.hypermedia.Hypermedia;
import de.arkadi.persistence.rest.hypermedia.LinkResource;
...
public class Book extends Hypermedia implements Serializable {
    ...
    public Book(String id, String title, String description, ArrayList<de.arkadi.persistence.rest.domain.Author> authors, Float price, String imageFileName, String link, Date published) {
        super();
    }
